...
def replace_llama(model, args):
    ...
    from benchmark.llama_hijack_4_46 import sparse_attn_forward, llama_model_forward
...
def replace_mistral(model, args):
    ...
    from sparse_attn.token_sparse.sparse_cluster import init_cluster, set_model
    from benchmark.mistral_hijack_4_46 import sparse_attn_forward, mistral_model_forward
